...
from nyc_taxi.pipeline.step_02_preprocessing.preprocessing.taxi.categorize_precipitation_temperature import apply_categorization
...
def preprocess_all_data():
    ...
    logger_py.info('Start applying categorization')
    apply_categorization()
    logger_py.info('Finish applying categorization')
